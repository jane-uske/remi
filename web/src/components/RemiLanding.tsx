...
const CAPS = [
  ...
  { tag: "STT · TTS", t: "语音交互", p: "全双工语音输入输出，逐句流式合成，说到一半也能随时被打断。" },
  { tag: "VRM · Live2D", t: "虚拟形象", p: "三维角色与 Live2D 形象，情绪驱动表情、动作触发与嘴型同步。" },
  { tag: "WebSocket", t: "实时通信", p: "全双工实时通道，流式 token 推送，毫秒级打断控制，稳定不掉线。" },
];
  ...
  return (
    <main className="remi-portal relative min-h-dvh w-full overflow-x-hidden" style={{ color: "var(--foreground)" }}>
      ...
      <div className="relative z-[2]">
        ...
        {/* hero */}
        <header className="mx-auto flex min-h-[88vh] max-w-5xl flex-col justify-center px-6 md:px-10">
          <span
          ...
          <p className="mt-5 text-lg md:text-2xl" style={{ letterSpacing: ".02em" }}>
            ...
            <b style={{ color: "var(--remi-accent)", fontWeight: 500 }}>有形象</b>
          </p>
        ...
        {/* capabilities */}
        <Section id="features" eyebrow="核心能力" title="支撑「活人感」的系统" sub="双脑调度、长期记忆、情绪与语音，构成一条低延迟、可打断的实时陪伴主链路。">
