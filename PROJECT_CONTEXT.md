...
Rem 不是一个“会聊天的应用”。
Rem 想做的是一个跨终端、持续在线、随时可陪伴、像活人一样存在的 AI 伴侣。
...
换句话说，Rem 的未来不是“做更多页面”。
而是让同一个 Rem 可以通过不同能力壳子进入用户生活。
...
> Rem 是一个以“活人感、连续性、存在感”为核心目标的实时 AI 陪伴系统。
...
> Rem 是一个以存在感为中心、以实时语音和人格连续性为核心优势的 AI 陪伴系统。
